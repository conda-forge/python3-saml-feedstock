...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python3-saml-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12068&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python3-saml-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python3-saml` can be installed with:

```
conda install python3-saml
```

It is possible to list all of the versions of `python3-saml` available on your platform with:
